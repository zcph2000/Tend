...
import SeasonPlanTool from "./SeasonPlanTool";
  ...
  return (
    <div className="space-y-4 pb-24">
      <div className="flex items-center gap-2">
        ...
        <div>
          <h1 className="text-2xl font-bold text-earth-50">Sæsonplan</h1>
          <p className="text-sm text-earth-300 mt-0.5">
            Sæt hele restaurantens behov ind på én gang og fordel det ud over bedene
          </p>
        </div>
      </div>
      <SeasonPlanTool
