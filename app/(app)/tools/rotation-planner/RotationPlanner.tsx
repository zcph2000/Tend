          ...
          <div className="rounded-xl px-3 py-2.5 border border-white/10 text-xs">
            ...
            {soilLabel ? (
              ...
              <p className="text-earth-500">Ingen jordtype sat på de valgte marker —{" "}
                <a href="/farming" className="underline hover:text-earth-300 transition-colors">sæt den under Jordbrug</a>
              </p>
            )}
          </div>
        )}
  ...
  if (done) {
    return (
      <div className="rounded-xl px-4 py-3 flex items-center justify-between" style={{ background: "rgba(99,107,60,0.15)", border: "1px solid rgba(99,107,60,0.3)" }}>
        ...
        <a href="/farming/pastures" className="text-xs text-grass-200 underline">Se marker →</a>
      </div>
    );
  }
