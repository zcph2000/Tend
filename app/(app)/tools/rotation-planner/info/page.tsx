...
export default function PlannerInfoPage() {
  return (
    <div className="space-y-4">
      <Link href="/tools/rotation-planner" className="text-sm text-earth-300 flex items-center gap-1">
        ← Rotationsplanlægger
      </Link>
      ...
      <Link href="/tools/rotation-planner" className="btn-primary w-full text-center block">
