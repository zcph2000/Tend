...
export default async function SettingsPage() {
  ...
  return (
    <div className="space-y-4">
      <div className="card">
        <h2 className="font-semibold text-earth-900 mb-1">Din konto</h2>
      ...
      <div className="card">
        <h3 className="font-semibold text-earth-800 mb-3">Om Tend</h3>
        ...
        <p className="text-earth-400 text-xs mt-2">Version 0.1.0 · 2025</p>
      </div>
